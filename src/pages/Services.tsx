  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 md:ml-64 pb-16 md:pb-8 pt-14 md:pt-14">
        <div className="max-w-full sm:max-w-xl lg:max-w-2xl mx-auto px-0 sm:px-4 md:px-6 pt-0 sm:pt-4 md:pt-6">
          {/* Header */}
          ...
          {/* Services Grid */}
          <div className="grid grid-cols-1 gap-3 sm:gap-4 px-0 sm:px-0">
