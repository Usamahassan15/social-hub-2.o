  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 md:ml-64 pb-16 md:pb-8 pt-14 md:pt-14">
        <div className="w-full max-w-none sm:max-w-md md:max-w-xl lg:max-w-2xl mx-0 sm:mx-auto px-0 sm:px-4 md:px-6 pt-0 sm:pt-4 md:pt-8">
          {/* Stories */}
          <motion.div
          ...
          {/* Posts Feed */}
          <div className="space-y-0 sm:space-y-3 md:space-y-4 lg:space-y-5">
