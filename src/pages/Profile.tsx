  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 md:ml-64 pb-16 md:pb-8 pt-14 md:pt-14">
        <div className="w-full max-w-[100vw] sm:max-w-xl lg:max-w-4xl xl:max-w-5xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8">
          {/* Cover Photo */}
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* Dynamic Content */}
          <div className="px-0 sm:px-4 md:px-6 lg:flex lg:justify-center">
            <div className="w-full lg:max-w-[680px] lg:mx-auto">
