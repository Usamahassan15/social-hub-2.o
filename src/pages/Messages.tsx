...
const Messages = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className={`flex-1 md:ml-64 pt-14 md:pt-14 ${showConversationList ? 'pb-16' : 'pb-0'} md:pb-8 flex justify-center lg:px-8`}>
        <div className={`${showConversationList ? 'h-[calc(100vh-8rem)]' : 'h-[calc(100vh-3.5rem)]'} md:h-[calc(100vh-4rem)] flex w-full max-w-4xl mx-auto`}>
          {/* Conversations List */}
          <div
            className={`${
