  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 md:ml-64 pb-16 md:pb-8 pt-14 md:pt-14">
        <div className="w-full max-w-[100vw] sm:max-w-md md:max-w-4xl lg:max-w-5xl xl:max-w-5xl mx-auto px-1.5 sm:px-4 md:px-6 lg:px-8 pt-2 sm:pt-4 md:pt-6 overflow-hidden">
          {/* Header */}
          <motion.div 
